...
def polygon_stocks_load_dag():
    """
    This DAG loads raw JSON stock data from S3 into Snowflake using the
    COPY INTO command. It's triggered by the completion of an ingest DAG.
    """
    ...
    def get_s3_keys_from_manifest() -> list[str]:
        """Reads the manifest file from S3 to get the list of new JSON files."""
